...
import { isTruthy as isTruthy2 } from "@clerk/shared/underscore";
var cloudflareEnv;
...
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return import.meta.env[envVarName] || void 0;
}
function getSafeEnv(context) {
  ...
  return {
    ...
    telemetryDisabled: isTruthy2(getContextEnvVar("PUBLIC_CLERK_TELEMETRY_DISABLED", context)),
    telemetryDebug: isTruthy2(getContextEnvVar("PUBLIC_CLERK_TELEMETRY_DEBUG", context)),
...
// src/server/keyless/file-storage.ts
